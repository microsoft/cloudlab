#
# Module manifest for module 'CloudLab'
#
...
Description = 'PowerShell module to create and manage a Microsoft 365 Cloud Lab environment.'
...
FunctionsToExport = 'Connect-CloudLab', 'Invoke-CloudLab'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        LicenseUri = 'https://github.com/microsoft/cloudlab/blob/main/LICENSE'

        # A URL to the main website for this project.
        ProjectUri = 'https://github.com/microsoft/cloudlab'
